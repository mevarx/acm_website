...
export default function HeroTerminal() {
  ...
  return (
    /* Fixed 420px width — shrinks on narrow viewports */
    <div style={{ width: '420px', maxWidth: '100%', flexShrink: 0 }} className="font-mono text-sm select-none pointer-events-none">
