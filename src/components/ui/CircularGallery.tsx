...
function autoBind(instance: object) {
  ...
  Object.getOwnPropertyNames(proto).forEach(key => {
    if (key !== 'constructor' && typeof (instance as Record<string, unknown>)[key] === 'function') {
      (instance as Record<string, unknown>)[key] = ((instance as Record<string, (...args: unknown[]) => unknown>)[key]).bind(instance);
    }
  });
}
...
class App {
  ...
  createMedias(items?: GalleryItem[], bend = 1, textColor = '#ffffff', borderRadius = 0, font = 'bold 30px Figtree') {
    const defaultItems: GalleryItem[] = [
      { image: 'https://picsum.photos/seed/1/800/600', text: 'Gallery' },
      { image: 'https://picsum.photos/seed/2/800/600', text: 'Gallery' },
      { image: 'https://picsum.photos/seed/3/800/600', text: 'Gallery' },
      { image: 'https://picsum.photos/seed/4/800/600', text: 'Gallery' },
      { image: 'https://picsum.photos/seed/5/800/600', text: 'Gallery' },
      { image: 'https://picsum.photos/seed/6/800/600', text: 'Gallery' },
    ];
